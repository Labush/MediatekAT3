...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 04 avr. 2022 à 16:14
...
--
-- Structure de la table `suivicmddoc`
--

DROP TABLE IF EXISTS `suivicmddoc`;
CREATE TABLE IF NOT EXISTS `suivicmddoc` (
  `idsuivi` int(5) NOT NULL,
  `idcommande` varchar(5) NOT NULL,
  PRIMARY KEY (`idsuivi`,`idcommande`),
  KEY `suivicmddoc_fk2` (`idcommande`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Déchargement des données de la table `suivicmddoc`
--

INSERT INTO `suivicmddoc` (`idsuivi`, `idcommande`) VALUES
(1, '1'),
(2, '2');
...
CREATE TABLE IF NOT EXISTS `utilisateur` (
  ...
  PRIMARY KEY (`nom`),
  KEY `I_FK_UTILISATEUR_SERVICE` (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
('admin', 1, '5690f6355932258334005760778de9f5'),
('services_admin', 2, '4acfb1385de8f84de1c6da2fc060a4ee'),
('pret', 3, 'c35e86f9238cb335bcb50e9cf381cfeb'),
('culture', 4, '70110e1961e362a2066a186d5f1f3731');
...
--
-- Contraintes pour la table `suivicmddoc`
--
ALTER TABLE `suivicmddoc`
  ADD CONSTRAINT `suivicmddoc_fk1` FOREIGN KEY (`idsuivi`) REFERENCES `suivi` (`id`),
  ADD CONSTRAINT `suivicmddoc_fk2` FOREIGN KEY (`idcommande`) REFERENCES `commandedocument` (`id`);
COMMIT;
